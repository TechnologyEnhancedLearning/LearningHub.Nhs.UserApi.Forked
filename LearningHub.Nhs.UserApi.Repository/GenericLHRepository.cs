// <copyright file="GenericLHRepository.cs" company="HEE.nhs.uk">
...
namespace LearningHub.Nhs.UserApi.Repository
{
    ...
    using LearningHub.Nhs.UserApi.Repository.LH;
    ...
    public class GenericLHRepository<TEntity> : IGenericLHRepository<TEntity>
        where TEntity : EntityBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GenericLHRepository{TEntity}"/> class.
        /// </summary>
        ...
        /// </param>
        public GenericLHRepository(LearningHubDbContext dbContext, ITimezoneOffsetManager tzOffsetManager)
        {
